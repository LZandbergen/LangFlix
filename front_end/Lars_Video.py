...
class Video(QtWidgets.QWidget):
     def __init__(self):
        ...
        self.isPaused = True
        self.isMuted = True
        self.subs_orig = pysrt.open("back_end/MANUAL_Money.Heist.S01E01.XviD-AFG-eng copy.srt")
        self.subs_cur = pysrt.open("back_end/MANUAL_Money.Heist.S01E01.XviD-AFG-eng copy.srt")
     ...
     def set_play_button_style(self):
         ...
         if self.player.is_playing():
             self.player.video_set_subtitle_file("front_end/MANUAL_Money.Heist.S01E01.XviD-AFG-eng.wordsreplaced.srt")
     ...
     def prep_subs(self):
         ...
         self.subs_cur.save('front_end/MANUAL_Money.Heist.S01E01.XviD-AFG-eng.wordsreplaced.srt', encoding='utf-8')